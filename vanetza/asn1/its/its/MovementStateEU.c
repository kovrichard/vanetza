...
static asn_SET_OF_specifics_t asn_SPC_regional_specs_6 = {
	sizeof(struct MovementStateEU__regional),
	offsetof(struct MovementStateEU__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_MovementStateEU_1[] = {
	{ ATF_POINTER, 1, offsetof(struct MovementStateEU, movementName),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MovementStateEU, signalGroup),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MovementStateEU, state_time_speed),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_MovementEventListEU,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"state-time-speed"
		},
	{ ATF_POINTER, 2, offsetof(struct MovementStateEU, maneuverAssistList),
	...
	{ ATF_POINTER, 1, offsetof(struct MovementStateEU, regional),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_regional_6,
		0,
...
static const int asn_MAP_MovementStateEU_oms_1[] = { 0, 3, 4 };
static const ber_tlv_tag_t asn_DEF_MovementStateEU_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MovementStateEU_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_MovementStateEU_specs_1 = {
	sizeof(struct MovementStateEU),
	offsetof(struct MovementStateEU, _asn_ctx),
	asn_MAP_MovementStateEU_tag2el_1,
	5,	/* Count of tags in the map */
	asn_MAP_MovementStateEU_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	5,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_MovementStateEU = {
	"MovementStateEU",
	"MovementStateEU",
	&asn_OP_SEQUENCE,
	asn_DEF_MovementStateEU_tags_1,
	sizeof(asn_DEF_MovementStateEU_tags_1)
		/sizeof(asn_DEF_MovementStateEU_tags_1[0]), /* 1 */
	asn_DEF_MovementStateEU_tags_1,	/* Same as above */
	sizeof(asn_DEF_MovementStateEU_tags_1)
		/sizeof(asn_DEF_MovementStateEU_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_MovementStateEU_1,
	5,	/* Elements count */
	&asn_SPC_MovementStateEU_specs_1	/* Additional specs */
};
