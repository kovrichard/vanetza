...
#include "SegmentAttributeXYEU.h"

/*
 * This type is implemented using NativeEnumerated,
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_SegmentAttributeXYEU_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_SegmentAttributeXYEU_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  6,  6,  0,  37 }	/* (0..37,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_SegmentAttributeXYEU_value2enum_1[] = {
	{ 0,	8,	"reserved" },
	{ 1,	10,	"doNotBlock" },
	{ 2,	9,	"whiteLine" },
...
static const unsigned int asn_MAP_SegmentAttributeXYEU_enum2value_1[] = {
...
const asn_INTEGER_specifics_t asn_SPC_SegmentAttributeXYEU_specs_1 = {
	asn_MAP_SegmentAttributeXYEU_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_SegmentAttributeXYEU_enum2value_1,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_SegmentAttributeXYEU_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
asn_TYPE_descriptor_t asn_DEF_SegmentAttributeXYEU = {
	"SegmentAttributeXYEU",
	"SegmentAttributeXYEU",
	&asn_OP_NativeEnumerated,
	asn_DEF_SegmentAttributeXYEU_tags_1,
	sizeof(asn_DEF_SegmentAttributeXYEU_tags_1)
		/sizeof(asn_DEF_SegmentAttributeXYEU_tags_1[0]), /* 1 */
	asn_DEF_SegmentAttributeXYEU_tags_1,	/* Same as above */
	sizeof(asn_DEF_SegmentAttributeXYEU_tags_1)
		/sizeof(asn_DEF_SegmentAttributeXYEU_tags_1[0]), /* 1 */
	{ &asn_OER_type_SegmentAttributeXYEU_constr_1, &asn_PER_type_SegmentAttributeXYEU_constr_1, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_SegmentAttributeXYEU_specs_1	/* Additional specs */
};
