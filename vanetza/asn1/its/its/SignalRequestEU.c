...
static asn_SET_OF_specifics_t asn_SPC_regional_specs_7 = {
	sizeof(struct SignalRequestEU__regional),
	offsetof(struct SignalRequestEU__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SignalRequestEU_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SignalRequestEU, id),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SignalRequestEU, requestID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SignalRequestEU, requestType),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PriorityRequestTypeEU,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"requestType"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SignalRequestEU, inBoundLane),
	...
	{ ATF_POINTER, 2, offsetof(struct SignalRequestEU, outBoundLane),
	...
	{ ATF_POINTER, 1, offsetof(struct SignalRequestEU, regional),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_regional_7,
		0,
...
static const int asn_MAP_SignalRequestEU_oms_1[] = { 4, 5 };
static const ber_tlv_tag_t asn_DEF_SignalRequestEU_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SignalRequestEU_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_SignalRequestEU_specs_1 = {
	sizeof(struct SignalRequestEU),
	offsetof(struct SignalRequestEU, _asn_ctx),
	asn_MAP_SignalRequestEU_tag2el_1,
	6,	/* Count of tags in the map */
	asn_MAP_SignalRequestEU_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	6,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_SignalRequestEU = {
	"SignalRequestEU",
	"SignalRequestEU",
	&asn_OP_SEQUENCE,
	asn_DEF_SignalRequestEU_tags_1,
	sizeof(asn_DEF_SignalRequestEU_tags_1)
		/sizeof(asn_DEF_SignalRequestEU_tags_1[0]), /* 1 */
	asn_DEF_SignalRequestEU_tags_1,	/* Same as above */
	sizeof(asn_DEF_SignalRequestEU_tags_1)
		/sizeof(asn_DEF_SignalRequestEU_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_SignalRequestEU_1,
	6,	/* Elements count */
	&asn_SPC_SignalRequestEU_specs_1	/* Additional specs */
};
