...
asn_TYPE_member_t asn_MBR_FreeSpaceArea_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct FreeSpaceArea, choice.freeSpaceRadial),
...
static const asn_TYPE_tag2member_t asn_MAP_FreeSpaceArea_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* freeSpaceRadial */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* freeSpacePolygon */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* freeSpaceCircular */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* freeSpaceEllipse */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* freeSpaceRectangle */
};
