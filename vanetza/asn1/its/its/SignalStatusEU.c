...
static asn_SET_OF_specifics_t asn_SPC_regional_specs_5 = {
	sizeof(struct SignalStatusEU__regional),
	offsetof(struct SignalStatusEU__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SignalStatusEU_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SignalStatusEU, sequenceNumber),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SignalStatusEU, id),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SignalStatusEU, sigStatus),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SignalStatusPackageListEU,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"sigStatus"
		},
	{ ATF_POINTER, 1, offsetof(struct SignalStatusEU, regional),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_regional_5,
		0,
...
static const int asn_MAP_SignalStatusEU_oms_1[] = { 3 };
static const ber_tlv_tag_t asn_DEF_SignalStatusEU_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SignalStatusEU_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_SignalStatusEU_specs_1 = {
	sizeof(struct SignalStatusEU),
	offsetof(struct SignalStatusEU, _asn_ctx),
	asn_MAP_SignalStatusEU_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_SignalStatusEU_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	4,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_SignalStatusEU = {
	"SignalStatusEU",
	"SignalStatusEU",
	&asn_OP_SEQUENCE,
	asn_DEF_SignalStatusEU_tags_1,
	sizeof(asn_DEF_SignalStatusEU_tags_1)
		/sizeof(asn_DEF_SignalStatusEU_tags_1[0]), /* 1 */
	asn_DEF_SignalStatusEU_tags_1,	/* Same as above */
	sizeof(asn_DEF_SignalStatusEU_tags_1)
		/sizeof(asn_DEF_SignalStatusEU_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_SignalStatusEU_1,
	4,	/* Elements count */
	&asn_SPC_SignalStatusEU_specs_1	/* Additional specs */
};
