 ...
 */
static asn_oer_constraints_t asn_OER_type_TimeConfidenceEU_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_TimeConfidenceEU_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0,  39 }	/* (0..39) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_TimeConfidenceEU_value2enum_1[] = {
	{ 0,	11,	"unavailable" },
	{ 1,	12,	"time-100-000" },
	{ 2,	12,	"time-050-000" },
	{ 3,	12,	"time-020-000" },
...
static const unsigned int asn_MAP_TimeConfidenceEU_enum2value_1[] = {
...
const asn_INTEGER_specifics_t asn_SPC_TimeConfidenceEU_specs_1 = {
	asn_MAP_TimeConfidenceEU_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_TimeConfidenceEU_enum2value_1,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_TimeConfidenceEU_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
asn_TYPE_descriptor_t asn_DEF_TimeConfidenceEU = {
	"TimeConfidenceEU",
	"TimeConfidenceEU",
	&asn_OP_NativeEnumerated,
	asn_DEF_TimeConfidenceEU_tags_1,
	sizeof(asn_DEF_TimeConfidenceEU_tags_1)
		/sizeof(asn_DEF_TimeConfidenceEU_tags_1[0]), /* 1 */
	asn_DEF_TimeConfidenceEU_tags_1,	/* Same as above */
	sizeof(asn_DEF_TimeConfidenceEU_tags_1)
		/sizeof(asn_DEF_TimeConfidenceEU_tags_1[0]), /* 1 */
	{ &asn_OER_type_TimeConfidenceEU_constr_1, &asn_PER_type_TimeConfidenceEU_constr_1, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_TimeConfidenceEU_specs_1	/* Additional specs */
};
