...
static asn_SET_OF_specifics_t asn_SPC_regional_specs_5 = {
	sizeof(struct SPATEU__regional),
	offsetof(struct SPATEU__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SPATEU_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SPATEU, timeStamp),
	...
	{ ATF_POINTER, 1, offsetof(struct SPATEU, name),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SPATEU, intersections),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_IntersectionStateListEU,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"intersections"
		},
	{ ATF_POINTER, 1, offsetof(struct SPATEU, regional),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_regional_5,
		0,
...
static const int asn_MAP_SPATEU_oms_1[] = { 0, 1, 3 };
static const ber_tlv_tag_t asn_DEF_SPATEU_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SPATEU_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_SPATEU_specs_1 = {
	sizeof(struct SPATEU),
	offsetof(struct SPATEU, _asn_ctx),
	asn_MAP_SPATEU_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_SPATEU_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	4,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_SPATEU = {
	"SPATEU",
	"SPATEU",
	&asn_OP_SEQUENCE,
	asn_DEF_SPATEU_tags_1,
	sizeof(asn_DEF_SPATEU_tags_1)
		/sizeof(asn_DEF_SPATEU_tags_1[0]), /* 1 */
	asn_DEF_SPATEU_tags_1,	/* Same as above */
	sizeof(asn_DEF_SPATEU_tags_1)
		/sizeof(asn_DEF_SPATEU_tags_1[0]), /* 1 */
