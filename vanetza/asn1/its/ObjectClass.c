...
static asn_TYPE_member_t asn_MBR_class_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ObjectClass__class, choice.unknown),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_UnknownSubclass,
		0,
		{ 0, 0, 0 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ObjectClass__class, choice.vru),
...
static const asn_TYPE_tag2member_t asn_MAP_class_tag2el_3[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* vehicle */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* vru */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* animal */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* other */
};
