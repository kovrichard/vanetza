...
static asn_SET_OF_specifics_t asn_SPC_regional_specs_5 = {
	sizeof(struct Position3DEU__regional),
	offsetof(struct Position3DEU__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_Position3DEU_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Position3DEU, lat),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Position3DEU, Long),
	...
	{ ATF_POINTER, 2, offsetof(struct Position3DEU, elevation),
	...
	{ ATF_POINTER, 1, offsetof(struct Position3DEU, regional),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_regional_5,
		0,
...
static const int asn_MAP_Position3DEU_oms_1[] = { 2, 3 };
static const ber_tlv_tag_t asn_DEF_Position3DEU_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_Position3DEU_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_Position3DEU_specs_1 = {
	sizeof(struct Position3DEU),
	offsetof(struct Position3DEU, _asn_ctx),
	asn_MAP_Position3DEU_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_Position3DEU_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	4,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_Position3DEU = {
	"Position3DEU",
	"Position3DEU",
	&asn_OP_SEQUENCE,
	asn_DEF_Position3DEU_tags_1,
	sizeof(asn_DEF_Position3DEU_tags_1)
		/sizeof(asn_DEF_Position3DEU_tags_1[0]), /* 1 */
	asn_DEF_Position3DEU_tags_1,	/* Same as above */
	sizeof(asn_DEF_Position3DEU_tags_1)
		/sizeof(asn_DEF_Position3DEU_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_Position3DEU_1,
	4,	/* Elements count */
	&asn_SPC_Position3DEU_specs_1	/* Additional specs */
};
