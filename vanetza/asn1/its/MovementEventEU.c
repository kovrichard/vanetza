...
static asn_SET_OF_specifics_t asn_SPC_regional_specs_5 = {
	sizeof(struct MovementEventEU__regional),
	offsetof(struct MovementEventEU__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_MovementEventEU_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MovementEventEU, eventState),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_MovementPhaseStateEU,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"eventState"
		},
	{ ATF_POINTER, 3, offsetof(struct MovementEventEU, timing),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_TimeChangeDetailsEU,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"timing"
		},
	{ ATF_POINTER, 2, offsetof(struct MovementEventEU, speeds),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_AdvisorySpeedListEU,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"speeds"
		},
	{ ATF_POINTER, 1, offsetof(struct MovementEventEU, regional),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_regional_5,
		0,
...
static const int asn_MAP_MovementEventEU_oms_1[] = { 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_MovementEventEU_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MovementEventEU_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_MovementEventEU_specs_1 = {
	sizeof(struct MovementEventEU),
	offsetof(struct MovementEventEU, _asn_ctx),
	asn_MAP_MovementEventEU_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_MovementEventEU_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	4,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_MovementEventEU = {
	"MovementEventEU",
	"MovementEventEU",
	&asn_OP_SEQUENCE,
	asn_DEF_MovementEventEU_tags_1,
	sizeof(asn_DEF_MovementEventEU_tags_1)
		/sizeof(asn_DEF_MovementEventEU_tags_1[0]), /* 1 */
	asn_DEF_MovementEventEU_tags_1,	/* Same as above */
	sizeof(asn_DEF_MovementEventEU_tags_1)
		/sizeof(asn_DEF_MovementEventEU_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_MovementEventEU_1,
	4,	/* Elements count */
	&asn_SPC_MovementEventEU_specs_1	/* Additional specs */
};
